...
if __name__ == "__main__":
    ...
    SAVE_PATH = os.path.join(BASE_DIR, "data", "processed", "mean", "elapsed", f"{TARGET_DATE}_2.json")
    ...
    if MODE == "append":
        ...
        prev_path = os.path.join(BASE_DIR, "data", "processed", "mean", "elapsed", f"{prev_date}_2.json")
